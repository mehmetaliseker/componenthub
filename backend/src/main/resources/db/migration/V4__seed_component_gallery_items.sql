-- Built-in component gallery: 5 items with upsert by slug
  ...
  return (
    <div className="relative min-h-[240px] w-full">
      <div
        ...
        className={`w-56 cursor-grab rounded-xl border border-amber-400/30 bg-amber-500/10 p-4 shadow-xl backdrop-blur-sm active:cursor-grabbing ${
